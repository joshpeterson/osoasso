...
Define(SHA1)
{
    It("Hashes a short string")
    {
        ...
        AssertEqual<std::string>("a9993e36 4706816a ba3e2571 7850c26c 9cd0d89d", hasher.hash(data));
    } Done
    ...
    It("Hashes a long string")
    {
        ...
        AssertEqual<std::string>("84983e44 1c3bd26e baae4aa1 f95129e5 e54670f1", hasher.hash(data));
    } Done
}
