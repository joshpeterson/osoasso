...
TEST_CCFILES = test_harness/test.cc test/test_blob.cc test/test_sha1.cc test/test_commit.cc test/test_object_repository.cc test/test_command_parser.cc src/sha1.cc src/commit.cc src/command_parser.cc
