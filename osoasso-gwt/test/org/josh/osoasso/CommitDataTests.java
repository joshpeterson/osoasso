...
public class CommitDataTests
{
    ...
    {
        CommitData commitData = new CommitData("CommitName#foo([[1 5]], [[1 3]])#me@bar.com#Some time GMT#3.14#OutputName#[[1 2]]");
    ...
    {
        CommitData commitData = new CommitData("CommitName#foo([[1 5]], [[1 3]])#me@bar.com#Some time GMT#3.14#OutputName");
        assertFalse(commitData.hasMatrix());
    }

    @Test
    public void CheckCommandTime()
    {
        CommitData commitData = new CommitData("CommitName#foo([[1 5]], [[1 3]])#me@bar.com#Some time GMT#3.14#OutputName#[[1 2]]");
        assertEquals("3.14", commitData.getCommandElapsedTime());
    }
}
